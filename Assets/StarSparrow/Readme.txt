...
Pick your spaceship and assign a different color from the materials folder or create your own color. This pack uses a simple "Colorize" shader so you can customize your own color or remove logos or weathering effects. This shader is quite simple and only uses add, multiply and one-minus with the least amount of texture sampling and does not affect performance. 

If you still wish to use standard materials you can find them in the "Legacy" folder inside "Standard". The "Standard" folder can be safely deleted if not needed.
...
Examples were increased by 10 and I also removed the Bonus Items. If you still want the Bonus Items you can download them for free here: https://u3d.as/WJw

--------------------------------------------------------

This set has been provided as a free sample to test before purchasing the complete collection. The complete collection contains hundreds of spaceships and 17 different sets similar to this one! Additionally, with the complete collection the Star Sparrow texture resolution is 4K!
